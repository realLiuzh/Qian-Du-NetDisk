    ...
    <div class="rig">
        ...
        <div class="fileDownload">
            ...
            <div class="dtable">
                ...
                <%--                    <c:out value="files==null"></c:out>--%>
                <%--                    <script>--%>
                <%--                        console.log("showFiles()执行了....")--%>
                <%--                        showFiles();--%>
                <%--                    </script>--%>
                <%--                </c:if>--%>
                <%--                <c:if test="${files!=null}">--%>
...
<%--                    <c:out value="files!=nuldsadasl"></c:out>--%>
<%--                    <script>--%>
<%--                        console.log("showFiles()执行了....")--%>
<%--                        showFiles();--%>
<%--                    </script>--%>
<%--                </c:if>--%>
                <c:if test="${files.size()<=0}">
                    <c:out value="files!=nulldsad"></c:out>
                    <script>
                        console.log("showFiles()执行了....")
                        showFiles();
                    </script>
                    ...
                    <c:forEach items="${files}" var="file" step="1">
                        ...
                        <td>
                            ...
                            <c:choose>
                                ...
                                <c:when test="${fn:endsWith(theString,'jpeg')}">
                                    <a href="file/download/${file}"><img onclick="progress()"
                                                                         src="resources/images/fileDownJpg.png"/></a>
                                    <br>
                                    (jpg图) ${file}
                                ...
                                <c:when test="${fn:endsWith(theString,'pdf')}">
                                    <a href="file/download/${file}"><img onclick="progress()"
                                                                         src="resources/images/fileDownPdf.png"/></a>
                                    <br>
                                    (PDF) ${file}
                                </c:when>
                                ...
                                <c:otherwise>
                                    <a href="file/download/${file}"><img onclick="progress()"
                                                                         src="resources/images/fileDownOther.png"/></a>
                                    <br>
                                    (其它) ${file}
                                </c:otherwise>
